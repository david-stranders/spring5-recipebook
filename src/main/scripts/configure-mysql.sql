...
#Create database service accounts - from localhost
CREATE USER 'sfg_dev_user'@'localhost' IDENTIFIED BY 'dstranders';
CREATE USER 'sfg_prod_user'@'localhost' IDENTIFIED BY 'dstranders';
...
#Create database service accounts - from docker container
CREATE USER 'sfg_dev_user'@'%' IDENTIFIED BY 'dstranders';
CREATE USER 'sfg_prod_user'@'%' IDENTIFIED BY 'dstranders';

#Database grants - docker container
